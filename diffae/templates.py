...
def font32_autoenc_base():
    conf = autoenc_base()
    conf.data_name = 'fontlmdb32'
...
def font32_autoenc_10K():
    conf = font32_autoenc_base()
    conf.total_samples = 130_000_000
    conf.eval_ema_every_samples = 10_000_000
    conf.eval_every_samples = 10_000_000
    conf.name = 'font128_autoenc'
    return conf
...
def pretrain_font32_autoenc10K():
    conf = font32_autoenc_base()
    conf.pretrain = PretrainConfig(
        name='10K',
        path=f'checkpoints/{font32_autoenc_10K().name}/last.ckpt',
    )
    conf.latent_infer_path = f'checkpoints/{font32_autoenc_10K().name}/latent.pkl'
    return conf
