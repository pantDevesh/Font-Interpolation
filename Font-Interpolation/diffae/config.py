...
data_paths = {
    ...
    'fontlmdb32':
    # os.path.expanduser('../1M_all_fonts_data/'),
    os.path.expanduser('/home/devesh_temp/scratch/str_kiran/font_translator_gan_hindi/font_translator_gan/datasets/Devesh_data/lmdb')
}
...
class TrainConfig(BaseConfig):
    ...
    T: int = 1_000
    font32_autoenc_10Ktotal_samples: int = 10_000_000
    warmup: int = 0
    ...
    def make_dataset(self, path=None, **kwargs):
        if self.data_name == 'ffhqlmdb256':
            ...
            return CelebAlmdb(path=path or self.data_path,
                              ...
                              crop_d2c=True,
                              **kwargs)
        elif self.data_name == 'fontlmdb32':
            return FONTlmdb(path=path or self.data_path,
